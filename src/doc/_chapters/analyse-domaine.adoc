...
include::uc-joueur-tour.adoc[leveloffset=+2]

== Cas d'utilisation 3: Attaquer

include::use-case-attaquer.adoc[leveloffset=+2]

== Cas d'utilisation 4: Défendre

include::use-case-defendre.adoc[leveloffset=+2]

== Cas d'utilisation 5: Renforcer un térritoire

include::use-case-renforcer-territoire.adoc[leveloffset=+2]
